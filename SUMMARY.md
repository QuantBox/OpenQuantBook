...
2. [SmartQuant公司的OpenQuant系统](whats_the_smartquant_or_openquant.md)

3. [OpenQuant软件下载、安装、运行](installing.md)

4. [获取国内市场数据](internal_market_data.md)

5. [导入csv或txt格式的数据](internal_market_data_csv.md)

6. [下载和安装插件](install_plugins.md)

7. [开始第一个策略](first_strategy.md)
